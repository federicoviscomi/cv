...
% \end{rSection}
  ...
  \begin{rSection}{Career history}
    ...
    \item[Summary:]
      Senior software developer. I'm working as a full stack enginer for a payment gateway. The languages and technologies used are: Java 8, OSGI, microservices, XML, REST API, Angular 5, Typescript.
    \end{rSubsection}
