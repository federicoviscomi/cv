...
% \end{rSection}
  ...
  \begin{rSection}{Career history}
    \begin{rSubsection}{Cisco International Ltd}{from April 2016, 1 years 9 months}{}{Staines UK}
    \item[Summary:]
    ...
    \begin{rSubsection}{Qualcomm UK Ltd}{from May 2014, 2 years}{}{Farnborough UK}
      %\item
      %\begin{description}
	\item[Summary:]
    ...
    \begin{rSubsection}{eBay International Marketing GmbH}{from September 2013, 6 months intenship}{}{Z\"urich, Switzerland}
      %\item
	%\begin{description}
	  \item[Summary:]  
    ...
    \begin{rSubsection}{ISTI - National Research Council of Italy}{from February 2009, 6 months internship}{}{Pisa, Italy}
      \item[Summary: ]
