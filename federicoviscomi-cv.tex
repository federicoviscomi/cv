...
%  I declare that no external recruiter has the legal right to ask a referral fee for this application TODO ask a sollicitor \\
    ...
    \begin{rSection}{Summary}
        ...
        %I value compassionate sharing of ideas and experties, adaptability and openness to changes.
...
% \end{rSection}
    ...
    \begin{rSection}{Career history}
        ...
        \begin{rSubsection}{Finastra}{Nottingham UK, from January 2018, current position, 3 years 3 months}{}{}
            ...
            %The languages and technologies used are: Maven, Java 8, Hibernate, Java EE, PostgreSQL, XML, Tomcat, Jboss, ZK, Apache Solr, Keycloak.
            %The system main use is exchange of SWIFT messages.
...
%            %  TODO
        ...
        \begin{rSubsection}{Qualcomm UK Ltd}{Farnborough UK, from May 2014, 2 years}{}{}
            ...
            %One of my tangible contributions to the company during my stay are in
            an Android smartphone (Sharp AQUOS ZETA SH-03G)
            %using Qualcomm MSM8994 chipset and running Android 5.0.
            ...
            %that is integrated	  %and that is
            %part of an authentication and mobile payment service offered by DOCOMO (Japan's predominant mobile operator).
    ...
    \begin{rSection}{Qualifications}
        ...
        % Freie Universit\"at Berlin \hfill{\em September 2011, 1 year}\\
