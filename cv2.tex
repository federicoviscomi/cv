...
%%
        ...
        \begin{position}
            ...
            The languages and technologies used are: %Maven, Java 8, Hibernate, Java EE, PostgreSQL, XML, Tomcat, Jboss, ZK, Apache Solr, Keycloak, Kafka, microservices, docker, ANTLR.
            Core Java 8, JEE,
        ...
        \end{position}
        \employer{\textbf{Aleph null limited}}
        \title{Software engineer}
        \location{Fully remote}
        \dates{December 2019 - June 2020}
        \begin{position}
            Part time contractor for redev technology ltd.
            One of the project is called fogsphere which is an IoT used to count people entering in a store using computer vision and machine learning.
            I worked on various components of the system:
            the IoT device with python,
            the backend with express and typescript deployed,
            the frontend written in react and typescript.
            The backend used a microservices architecture and was dockerized and deployed on AWS.
        \end{position}
